...
public class GeneralUpdateAction implements Action{
	...
	public String execute(RequestInfo request) {
		...
		log.writeLog("GeneralUpdateAction Start!!");
		...
		// 流程编码唯一
		String sysWorkflowField = vc.getSysWorkflowField();
		// 客户表
		...
		if(rs.next()){
			...
			String sysNo =  Util.null2String(rs.getString(sysWorkflowField));
