...
public class ForTheCostWorkfAction implements Action {
	...
	public String execute(RequestInfo info) {
		...
		String 	DateTime = "" ;//创建日期
		String SendDate = "";//寄件日期
		String 	Budget = "" ;//预算
		...
		if (!"".equals(tableName)) {
			...
			if(rs1.next()){
				...
				SendDate = Util.null2String(rs1.getString("SendDate"));//寄件日期
				kdcode = Util.null2String(rs1.getString("kdCode"));// 快递单号
				...
				mapStr.put("SendDate", SendDate);
				mapStr.put("kdcode", kdcode);
				
				//formtable_main_102是待结算表单。
				String tableNamex = "formtable_main_102";
